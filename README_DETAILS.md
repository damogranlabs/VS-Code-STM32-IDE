...
If this script is executed manually, tools paths are re-checked and user is asked if he wish to update paths.  
...
Once 'buildData.json' contains valid tools paths, 'toolsPaths.json' file is created/updated in VS Code appdata folder, typically this is in *%APPDATA%Code/User* folder.
